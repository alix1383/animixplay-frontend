    ...
    <div>
        ...
        <div class="-z-10 h-60 w-full overflow-hidden">
            <img
                ...
                :src="`http://127.0.0.1:8000/storage/img/mal/${animeInfoData.mal_id}.webp`"
...
const { data } = await useFetch(`http://localhost:8000/api/v1/anime/info/${route.params.animeid}`);
const animeInfoData = data.value as any;

// http://localhost:8000/api/v1/anime/info/54869
</script>
